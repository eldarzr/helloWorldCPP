...
hello: bin/HelloWorld.o bin/Run.o bin/Add.o
	@echo 'Building target: hello'
	@echo 'Invoking: C++ Linker'
	g++ -o bin/hello bin/HelloWorld.o bin/Run.o bin/Add.o
...
bin/Add.o: src/Add.cpp
	g++ -g -Wall -Weffc++ -std=c++11 -c -Iinclude -o bin/Add.o src/Add.cpp
